...
Template.Place_edit.onRendered(function() {
  ...
  $('[data-action=result]').validate({
    submitHandler: function() {
      ...
      console.log("UPDATED PLACE : " + update);
      var actodeId = FlowRouter.getParam('_id');
...
Template.Place_edit.helpers({
  place: () => {
    return Places.findOne(Session.get('editing'));
  }
});
Template.Place_edit.events({
