...
Template.Company_edit.onRendered(function() {
  ...
  if (this.data.person.bDay === undefined) {
    $('#bYearInput').val(5000).change();
    $('#bMonthInput').val(12).change();
    $('#bDayInput').val(0).change();
  } else {
    $('#bYearInput').val(this.data.person.bYear).change();
    $('#bMonthInput').val(this.data.person.bMonth).change();
    $('#bDayInput').val(this.data.person.bDay).change();
  }
  ...
  instance.$('[data-action=form]').validate({
    ...
    showErrors: function(errorMap, errorList) {
      instance.$("#summary").html("El formulario tiene errores (" +
    ...
    submitHandler: function() {
      ...
      let name = instance.$('#nameInput').val();
      let middleName = instance.$('#middleNameInput').val();
      let lastName = instance.$('#lastNameInput').val();
      let isMale = instance.$('#isMaleInput').is(':checked');
      let fin = instance.$('#finInput').val();
      let email = instance.$('#emailInput').val();
      let bDay = instance.$('#bDayInput').val();
      let bMonth = instance.$('#bMonthInput').val();
      let bYear = instance.$('#bYearInput').val();
      //var birthMoment;
      let mobile = instance.$('#mobileInput').val();
      ...
      let internalPhone = instance.$('#internalPhoneInput').val();
      ...
      if (
        ...
        let r = Meteor.user().relatedCompany;
        ...
        swal({
          title: "Ok " + name,
          text: "Tu perfil está actualizado",
          type: "success"
        });
